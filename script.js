// Wir importieren die pdf.js Bibliothek als ES6-Modul.
import * as pdfjsLib from "https://mozilla.github.io/pdf.js/build/pdf.mjs";

// Wir müssen den "Worker" für pdf.js bereitstellen, damit er im Hintergrund arbeiten kann.
pdfjsLib.GlobalWorkerOptions.workerSrc = `https://mozilla.github.io/pdf.js/build/pdf.worker.mjs`;

// Da dies ein Modul ist, wird der Code erst nach dem Laden des DOMs ausgeführt.
// Ein 'DOMContentLoaded' Event-Listener ist nicht mehr notwendig.

// --- KONSTANTEN UND INITIALDATEN ---
...
// KORREKTUR: Die Reihenfolge der Analyseschritte wurde wie gewünscht angepasst.
const analysisSteps = [
    ...
    { id: "datengrundlage", title: "Detaillierte Datengrundlage", content: `<section><h3>Detaillierte Datengrundlage für %%location%%</h3><p>Die nachfolgenden Kennzahlen bilden das quantitative Fundament dieser Analyse. Sie beschreiben den Zustand des lokalen Arbeitsmarktes und ermöglichen eine erste Einordnung der Herausforderungen und Chancen.</p><table class="data-table"><thead><tr><th>Kennzahl</th><th>Wert</th></tr></thead><tbody><tr><td>Arbeitslosenquote</td><td class="value">%%unemploymentRate%%%</td></tr><tr><td>Arbeitslose insgesamt</td><td class="value">%%totalUnemployed%%</td></tr><tr><td>Arbeitslose SGB III (Versicherung)</td><td class="value">%%unemployedSGB3%%</td></tr><tr><td>Arbeitslose SGB II (Grundsicherung)</td><td class="value">%%unemployedSGB2%%</td></tr><tr><td>Offene Stellen</td><td class="value">%%jobOpenings%%</td></tr></tbody></table><p><strong>Interpretation:</strong> Die Aufteilung zwischen SGB III und SGB II ist ein wichtiger Indikator. Ein hoher Anteil an SGB-II-Empfängern (Bürgergeld) deutet oft auf einen Bedarf an grundlegenderen Qualifizierungen und intensiverer Betreuung hin, während SGB-III-Empfänger (Arbeitslosengeld I) häufig näher am Arbeitsmarkt sind und von gezielten Weiterbildungen zur Anpassung ihrer Qualifikationen profitieren.</p></section>` },
    ...
    { id: "zielgruppenanalyse", title: "Analyse der arbeitslosen Zielgruppen", content: `<section><h3>Analyse der %%totalUnemployed%% Arbeitslosen nach Zielgruppen</h3><p>Um Qualifizierungsmaßnahmen erfolgreich zu gestalten, ist ein Verständnis der Zielgruppenstruktur unerlässlich. Die Daten zeigen, dass ein signifikanter Anteil der Arbeitslosen spezifische Merkmale aufweist, die bei der Kurskonzeption und -durchführung berücksichtigt werden müssen.</p><table class="data-table"><thead><tr><th>Zielgruppe</th><th>Anzahl</th></tr></thead><tbody><tr><td><div>Frauen</div></td><td class="value">%%unemployedWomen%%</td></tr><tr><td><div>Jugendliche (15-24 J.) <span class="female-quote">Frauenanteil: %%unemployedYouthFemale%%</span></div></td><td class="value">%%unemployedYouth%%</td></tr><tr><td><div>Ältere (50+) <span class="female-quote">Frauenanteil: %%unemployedSeniorsFemale%%</span></div></td><td class="value">%%unemployedSeniors%%</td></tr><tr><td><div>Ausländer/Geflüchtete <span class="female-quote">Frauenanteil: %%unemployedForeignersFemale%%</span></div></td><td class="value">%%unemployedForeigners%%</td></tr></tbody></table><p><strong>Interpretation:</strong> Die hohe Zahl älterer Arbeitsloser (%%unemployedSeniors%%) erfordert Angebote zum "Upskilling". Die Gruppe der Zugewanderten (%%unemployedForeigners%%) benötigt oft eine Kombination aus Fach- und Sprachqualifizierung. Der bedeutende Anteil an arbeitslosen Frauen (%%unemployedWomen%%) unterstreicht die Notwendigkeit von flexiblen Angeboten wie Teilzeit-Qualifizierungen, um den Wiedereinstieg in den Beruf zu erleichtern.</p></section>` },
    ...
    { id: "strategie", title: "Strategische Handlungsempfehlung", content: `<section><h3>Strategische Handlungsempfehlung für %%location%%</h3><p>Die vorangegangene datengestützte Analyse ermöglicht die Formulierung einer dreigliedrigen, integrierten Strategie. Ziel ist es, die Lücke zwischen dem Qualifikationsangebot von Donner und Partner und der Nachfrage der regionalen Wirtschaft effektiv zu schließen, die Vermittlungschancen der Teilnehmenden zu maximieren und den Standort nachhaltig als führenden Bildungsträger zu positionieren.</p><div class="strategy-container"><div class="strategy-card"><h4>1. Portfolio-Optimierung</h4><ul><li><strong>Fokussierung der Vermarktung auf Kernkompetenzen:</strong><div class="justification">Begründung: Dies betrifft insbesondere die Vermarktung von Maßnahmen wie der <strong>Umschulung zum/zur Fachinformatiker/in</strong> (um die %%jobsIT%% offenen Stellen zu adressieren) und der <strong>Qualifizierung zur Pflegeassistenz</strong> (um den Bedarf von %%jobsHealth%% Stellen zu decken).</div></li><li><strong>Schließung strategischer Angebotslücken:</strong><div class="justification">Begründung: Die Analyse identifizierte einen signifikanten Bedarf im Bereich der <strong>technischen Berufe (%%jobsTechnical%% Stellen)</strong>. Es wird die Einleitung eines Prüfverfahrens für neue Kursangebote (z.B. Mechatronik, Elektrotechnik) empfohlen.</div></li></ul></div><div class="strategy-card"><h4>2. Zielgruppenspezifische Ansprache</h4><ul><li><strong>Frauen (%%unemployedWomen%% Personen):</strong><div class="justification">Empfehlung: Aktive Bewerbung von <strong>Teilzeit-Qualifizierungen</strong>.</div></li><li><strong>Ältere Arbeitssuchende (50+, %%unemployedSeniors%% Personen):</strong><div class="justification">Empfehlung: Flexible Online-Angebote (VIONA®) und gezieltes Coaching.</div></li></ul></div><div class="strategy-card"><h4>3. Proaktive Marktbearbeitung</h4><ul><li><strong>Datengestützter Vertrieb:</strong><div class="justification">Beispiel: "Unsere Analyse für %%location%% zeigt einen Bedarf von über %%jobsCraft%% Fachkräften im Handwerk. Lassen Sie uns sprechen, wie wir helfen können."</div></li><li><strong>Aufbau strategischer Allianzen:</strong><div class="justification">Empfehlung: Kontakt zu Wirtschaftsverbänden, IHK/HWK und größten Arbeitgebern intensivieren.</div></li></ul></div></div></section>` },
...
const openLegalModalBtn = document.getElementById('open-legal-modal-btn');
...
function renderDashboardList(locations) {
    ...
    locations.forEach(standort => {
        ...
        listItem.querySelector('.upload-btn').addEventListener('click', (e) => { e.stopPropagation(); openUploadModal(standort.name); });
...
// --- FUNKTIONEN FÜR MODALS (UPLOAD & IMPRESSUM) ---
    ...
    try {
        ...
        fileReader.onload = async function() {
            try {
                ...
                // KORREKTUR: pdfjsLib wird direkt aus dem Import verwendet
                ...
                if (extractedData) {
                    ...
                    if (locationIndex !== -1) {
                        ...
                        uploadStatus.textContent = 'Daten erfolgreich aktualisiert!';
        ...
        uploadStatus.textContent = 'Fehler beim Lesen der Datei.';
        uploadStatus.className = 'error';
        spinner.style.display = 'none';
    }
}
...
function showStep(stepIndex) {
    ...
    readAloudBtn.style.display = isLastStep ? 'none' : 'inline-flex';
...
async function saveReport() {
    ...
    try {
        ...
        for (let i = 0; i < analysisSteps.length; i++) {
            ...
            if (step.id === 'abschluss') continue;
            progressText.textContent = `Verarbeite Seite ${i + 2} von ${totalSteps}...`;
            
            doc.addPage();
            currentY = MARGIN;
            addHeaderFooter(i + 2, totalSteps);
            ...
            for(const element of elements) {
                doc.setFont('Helvetica', 'normal');
                doc.setTextColor('#333132');
                if (currentY > 297 - MARGIN - 20) { doc.addPage(); currentY = MARGIN; addHeaderFooter(doc.internal.getNumberOfPages(), totalSteps); }
                if (element.tagName === 'P') {
                    ...
                    doc.autoTable({
                        ...
                        didDrawPage: (data) => {
                            addHeaderFooter(doc.internal.getNumberOfPages(), totalSteps);
                    ...
                    if (currentY + chartHeight > 297 - MARGIN - 15) { doc.addPage(); currentY = MARGIN; addHeaderFooter(doc.internal.getNumberOfPages(), totalSteps); }
